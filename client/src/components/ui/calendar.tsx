  ...
  ({
    ...
    return (
      <DayPicker
        ...
        className={cn("p-3 bg-black text-zinc-100 rounded-md ", className)}
        classNames={{
          months:
            "flex flex-col sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0 ",
          month: "space-y-4 bg-black rounded-lg p-4 ",
          caption:
        ...
        components={{
          IconLeft: () => <ChevronLeft className="h-4 w-4 text-zinc-400" />,
          IconRight: () => <ChevronRight className="h-4 w-4 text-zinc-400" />,
        }}
        {...props}
      />
    );
